...
// --- Generate SyntaxKindToString Start
    const char* SyntaxKindToString(SyntaxKind e) {
        switch(e) {
            ...
            case SyntaxKind::__FirstLiteral__: return "__FirstLiteral__";
            case SyntaxKind::BoolLiteral: return "BoolLiteral";
            case SyntaxKind::CharLiteral: return "CharLiteral";
            case SyntaxKind::FloatLiteral: return "FloatLiteral";
            case SyntaxKind::DoubleLiteral: return "DoubleLiteral";
            case SyntaxKind::Int32Literal: return "Int32Literal";
            case SyntaxKind::Int64Literal: return "Int64Literal";
            case SyntaxKind::UInt32Literal: return "UInt32Literal";
            case SyntaxKind::UInt64Literal: return "UInt64Literal";
            case SyntaxKind::__LastLiteral__: return "__LastLiteral__";
            ...
            case SyntaxKind::MultiLineComment: return "MultiLineComment";
            case SyntaxKind::SingleLineComment: return "SingleLineComment";
            case SyntaxKind::Whitespace: return "Whitespace";
            case SyntaxKind::NewLine: return "NewLine";
